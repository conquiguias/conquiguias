! function (e, t) {
  ...
  e.fn.lunaradio = function (i) {
      ...
      function Qe(t) {
          ...
          // localStorage deshabilitado - siempre usar volumen 100
          ae = 100;
          var o, r, s, l;
          ge = e("#" + n).width(), me = e("#" + n).height(), "small" == T && 0 == me && (De = !0, tt()), Ye("Roboto:400"), "" != B && Ye(B), o = "@keyframes " + n + "pulse { ", o = (o = (o = (o = (o = (o = (o = (o = (o = (o += "\t0% { ") + "\t  fill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0);") + "\t} ") + "\t50% { ") + "\t  fill: rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 1.0); ") + "\t} ") + "\t100% { ") + "\t\tfill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0); ") + "\t} ") + "}", e("head").append('<style type="text/css">' + o + "</style>"), r = window.location.href.toString().toLocaleLowerCase(), s = vt(E).toString(), "" != E && -1 != r.indexOf(vt("www.flashradio.info").toString())(".soda.info"), (! function () {
              ...
              m.addEventListener("timeupdate", function () {
                  ...
                  e("#" + n + "audiopreloader").fadeIn(0), e("#" + n + "smallaudiopreloader").fadeIn(0), xt("waiting")
                          ...
                          var te = a.hasOwnProperty("streamsuffix") ? a.streamsuffix : "/;type=mp3", ie = parseInt(Xe(a.metadatainterval, 2e4)), ae = parseInt(Xe(a.volume, 100)), oe = Xe(a.debug, "false").toString().toLowerCase(), re = Xe(a.autoplay, "false").toString().toLowerCase(), loopOnEnd = "true" == Xe(a.loopOnEnd, "true").toString().toLowerCase(), ne = Xe(a.displayliveicon, "true").toString().toLowerCase(), se = Xe(a.displayvisualizericon, "true").toString().toLowerCase();
                      ...
                      function (t) {
                          ...
                          a.id = n + "volumebackground", i.appendChild(a), e("#" + n + "volumebackground").css({
                              ...
                              onfinish: function (t) {
                                  e(this).css("cursor", k);
                                  try {
                                      // localStorage deshabilitado - no guardar volumen
                                  } catch (e) {
                                      xt(e)
                                  }
                              }
      ...
      this.stop = function () {
          if (Ie) {
              xt("API CALL: stop");
              try {
                  // **MEJORADO: Limpieza completa**
                  
                  // 1. Marcar como destruido
                  if (m) m.__lunaradio_destroyed = true;
                  
                  // 2. Cancelar setInterval de metadatos
                  if (window.__lunaradio_intervals && window.__lunaradio_intervals[n]) {
                      ...
                      xt("STOP: Metadata interval cleared");
                  }
                  
                  // 3. Pausa y limpia audio
                  lt();
                  Ze();
                  
                  // 4. Cerrar AudioContext y desconectar nodos
                  if (l) {
                      try {
                          if (h) { h.disconnect(); xt("STOP: MediaElementSource disconnected"); }
                          if (c) { c.disconnect(); xt("STOP: Analyser disconnected"); }
                          if (u) { u.disconnect(); xt("STOP: ScriptProcessor disconnected"); }
                          if (l.state !== "closed") {
                              l.close();
                              xt("STOP: AudioContext closed");
                          }
                      } catch(e) { xt("STOP: AudioContext error - " + e); }
                      l = undefined;
                      c = undefined;
                      u = undefined;
                      h = undefined;
                  ...
                  if (d && p) {
                      try {
                          p.clearRect(0, 0, d.width, d.height);
                          xt("STOP: Canvas cleared");
                      } catch(e) {}
                  }
                  
                  xt("STOP: ✓ Limpieza completada");
              } catch (e) {
                  xt(e)
              }
          }
