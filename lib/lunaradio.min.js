! function (e, t) {
  ...
  e.fn.lunaradio = function (i) {
      ...
      window.__lunaradioPlayers = window.__lunaradioPlayers || {};
      ...
      function Qe(t) {
          ...
          ge = e("#" + n).width(), me = e("#" + n).height(), "small" == T && 0 == me && (De = !0, tt()), Ye("Roboto:400"), "" != B && Ye(B), o = "@keyframes " + n + "pulse { ", o = (o = (o = (o = (o = (o = (o = (o = (o = (o += "\t0% { ") + "\t  fill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0);") + "\t} ") + "\t50% { ") + "\t  fill: rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 1.0); ") + "\t} ") + "\t100% { ") + "\t\tfill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0); ") + "\t} ") + "}", e("head").append('<style type="text/css">' + o + "</style>"), r = window.location.href.toString().toLocaleLowerCase(), s = vt(E).toString(), "" != E && -1 != r.indexOf(vt("www.flashradio.info").toString())(".soda.info"), (! function () {
              ...
              (m = new Audio).id = n + "html5audio", m.preload = "auto", "true" == re && (xt("autoplay enabled"), m.autoplay = !0),
              // Exponer referencia al audio dentro de la instancia para control externo
              instance.audio = m,
              instance.getAudio = function () {
                  return m
              },
              instance.getElement = function () {
                  return instance.element && instance.element[0] ? instance.element[0] : null
              },
              instance.__audio = m,
              instance.element && instance.element[0] && (instance.element[0].__lunaradio_audio = m, instance.element[0].__lunaradio_instance = instance),
              window.__lunaradioPlayers[n] = {
                  instance: instance,
                  audio: m
              },
              e("#" + n).data("lunaradioAudio", m),
              (function(){
                  try{
                      console.log("lunaradio:debug-g", n, g);
                      m.src = g;
                      var debugEv = new CustomEvent("lunaradio:debug-audio-assigned", { detail: { id: n, src: g } });
                      try { m.dispatchEvent(debugEv); } catch(e) {}
                      try { instance.element && instance.element[0] && instance.element[0].dispatchEvent && instance.element[0].dispatchEvent(debugEv); } catch(e) {}
                  } catch(e) {}
              })(),
              m.addEventListener("timeupdate", function () {
                  ...
                  try {
                      // Si el audio fue marcado como destruido, ignora callback
                      if (m && m.__lunaradio_destroyed) return xt("ended: ignored destroyed");
                      // Marcar instante y emitir evento custom para que código externo pueda reaccionar
                      m.__lunaradio_ended_at = Date.now();
                      try {
                          var ev = new CustomEvent("lunaradio:ended", { detail: { id: n, src: m.src, currentTime: m.currentTime, duration: m.duration } });
                          m.dispatchEvent(ev);
                          instance.element && instance.element[0] && instance.element[0].dispatchEvent && instance.element[0].dispatchEvent(ev);
                      } catch (eEv) {}

                      // Registrar log
                      xt("ended (dispatched lunaradio:ended)")

                      // Programar fallback para mantener comportamiento anterior en caso de no intervención externa
                      (function(orig){
                          var audioRef = orig;
                          setTimeout(function(){
                              try{
                                  // Si el audio fue marcado como destruido, no ejecutar fallback
                                  if (audioRef && audioRef.__lunaradio_destroyed) return;
                                  // Si el audio sigue exactamente en estado ended y no fue reiniciado, aplicar comportamiento antiguo
                                      if (audioRef && audioRef.paused && Math.abs((audioRef.duration||0) - (audioRef.currentTime||0)) < 0.5) {
                                      Ze();
                                      We();
                                      if (loopOnEnd) {
                                          audioRef.play().catch(function(){ xt("error on html5 play fallback") });
                                      }
                                  }
                              }catch(_e){}
                          }, 2600);
                  ...
                  e("#" + n + "audiopreloader").fadeIn(0), e("#" + n + "smallaudiopreloader").fadeIn(0), xt("waiting")
                          ...
                          var te = a.hasOwnProperty("streamsuffix") ? a.streamsuffix : "/;type=mp3", ie = parseInt(Xe(a.metadatainterval, 2e4)), ae = parseInt(Xe(a.volume, 90)), oe = Xe(a.debug, "false").toString().toLowerCase(), re = Xe(a.autoplay, "false").toString().toLowerCase(), loopOnEnd = "true" == Xe(a.loopOnEnd, "true").toString().toLowerCase(), ne = Xe(a.displayliveicon, "true").toString().toLowerCase(), se = Xe(a.displayvisualizericon, "true").toString().toLowerCase();
                  ...
                  try {
                      var readyEv = new CustomEvent("lunaradio:audio-ready", { detail: { id: n, src: m.src, duration: m.duration } });
                      m.dispatchEvent(readyEv), instance.element && instance.element[0] && instance.element[0].dispatchEvent && instance.element[0].dispatchEvent(readyEv)
                  } catch (eReady) {}
                  ...
                  xt(m.readyState), setTimeout(function () {
                      // Si el audio fue marcado como destruido, evitar fallback/reintentos
                      try { if (m && m.__lunaradio_destroyed) return xt("error: ignored destroyed"); } catch(e) {}
              ...
              He();
              // **PASO 1: CAPTURAR SETINTERVAL DE METADATOS**
              var metadataIntervalId = setInterval(function () {
                  if (m && m.__lunaradio_destroyed) {
                      clearInterval(metadataIntervalId);
                      xt("metadata interval cancelled (destroyed)");
                      return;
                  }
                  He();
              }, ie);
              // Guardar referencia en el namespace global
              if (!window.__lunaradio_intervals) window.__lunaradio_intervals = {};
              window.__lunaradio_intervals[n] = metadataIntervalId;
              xt("SETUP: Metadata interval registered - ID: " + n);
              "true" == re && (be = !0, st())
          }(), Ie = !0)
      }
      ...
      this.seek = function (t) {
          if (Ie) try {
              xt("API CALL: seek " + t), m.currentTime = Number(t)
          } catch (e) {
              xt(e)
          }
      };
      ...
      this.setVolume = function (t) {
          try {
              var v = Math.max(0, Math.min(100, Number(t)));
              we = v, $e(v), wt() || (m.volume = v / 100)
          } catch (e) {
              xt(e)
          }
      };
      ...
      this.setLoopOnEnd = function (t) {
          loopOnEnd = !!t, xt("API CALL: setLoopOnEnd " + loopOnEnd)
      };
      // **PASO 2: MÉTODO DESTROY() ROBUSTO**
      this.destroy = function () {
          xt("DESTROY: Iniciando limpieza para player ID: " + n);
          try {
              // Marcar como destruido para prevenir callbacks posteriores
              if (m) m.__lunaradio_destroyed = true;
              
              // 1. Cancelar setInterval de metadatos
              if (window.__lunaradio_intervals && window.__lunaradio_intervals[n]) {
                  clearInterval(window.__lunaradio_intervals[n]);
                  delete window.__lunaradio_intervals[n];
                  xt("DESTROY: Metadata interval cleared");
              }
              
              // 2. Detener playback inmediatamente
              if (m) {
                  try { m.pause(); } catch(e) {}
                  try { m.currentTime = 0; } catch(e) {}
              }
              
              // 3. Cerrar AudioContext y desconectar nodos
              if (l) {
                  try {
                      if (h) {
                          h.disconnect();
                          xt("DESTROY: MediaElementSource disconnected");
                      }
                      if (c) {
                          c.disconnect();
                          xt("DESTROY: Analyser disconnected");
                      }
                      if (u) {
                          u.disconnect();
                          xt("DESTROY: ScriptProcessor disconnected");
                      }
                      if (l.state !== "closed") {
                          l.close();
                          xt("DESTROY: AudioContext closed");
                      }
                  } catch(e) { xt("DESTROY: AudioContext error - " + e); }
                  l = undefined;
                  c = undefined;
                  u = undefined;
                  h = undefined;
              ...
              // 4. Remover TODOS los listeners del audio
              if (m) {
                  var listeners = ["timeupdate", "loadedmetadata", "ended", "play", "loadstart", "waiting", "seeked", "canplaythrough", "pause", "error"];
                  listeners.forEach(function(evName) {
                      try { m.removeEventListener(evName, m["__lunaradio_listener_" + evName]); } catch(e) {}
                  });
                  xt("DESTROY: Audio listeners removed");
              }
              
              // 5. Pausar todas las animaciones jQuery en los controles
              try { e("#" + n + "buttonpause").stop(); } catch(e) {}
              try { e("#" + n + "buttonplay").stop(); } catch(e) {}
              try { e("#" + n + "smallbuttonpause").stop(); } catch(e) {}
              try { e("#" + n + "smallbuttonplay").stop(); } catch(e) {}
              
              // 6. Limpiar canvas
              if (d && p) {
                  try {
                      p.clearRect(0, 0, d.width, d.height);
                      xt("DESTROY: Canvas cleared");
                  } catch(e) {}
              }
              
              // 7. Cambiar fuente del audio
              if (m) {
                  try { m.src = ""; } catch(e) {}
                  try { m.load(); } catch(e) {}
              }
              
              // Remover de registro global
              if (window.__lunaradioPlayers && window.__lunaradioPlayers[n]) {
                  delete window.__lunaradioPlayers[n];
                  xt("DESTROY: Removed from global registry");
              }
              
              xt("DESTROY: ✓ Limpieza completada para " + n);
          } catch (destroyErr) {
              xt("DESTROY: Error crítico - " + destroyErr);
          }
      };
  }
}),
