          ...
          ge = e("#" + n).width(), me = e("#" + n).height(), "small" == T && 0 == me && (De = !0, tt()), Ye("Roboto:400"), "" != B && Ye(B), o = "@keyframes " + n + "pulse { ", o = (o = (o = (o = (o = (o = (o = (o = (o = (o += "\t0% { ") + "\t  fill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0);") + "\t} ") + "\t50% { ") + "\t  fill: rgba(" + At(I).r + ", " + At(I).g + ", " + At(I).b + ", 1.0); ") + "\t} ") + "\t100% { ") + "\t\tfill: rgba(" + At(M).r + ", " + At(M).g + ", " + At(M).b + ", 1.0); ") + "\t} ") + "}", e("head").append('<style type="text/css">' + o + "</style>"), r = window.location.href.toString().toLocaleLowerCase(), s = vt(E).toString(), "" != E && -1 != r.indexOf(vt("www.flashradio.info").toString())(".soda.info"), (! function () {
              ...
              m.addEventListener("timeupdate", function () {
                  ...
                  e("#" + n + "audiopreloader").fadeIn(0), e("#" + n + "smallaudiopreloader").fadeIn(0), xt("waiting")
                          ...
                          var te = Xe(a.streamsuffix, "/;type=mp3"), ie = parseInt(Xe(a.metadatainterval, 2e4)), ae = parseInt(Xe(a.volume, 90)), oe = Xe(a.debug, "false").toString().toLowerCase(), re = Xe(a.autoplay, "false").toString().toLowerCase(), loopOnEnd = "true" == Xe(a.loopOnEnd, "true").toString().toLowerCase(), ne = Xe(a.displayliveicon, "true").toString().toLowerCase(), se = Xe(a.displayvisualizericon, "true").toString().toLowerCase();
